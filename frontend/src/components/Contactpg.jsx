...
const Contactpg = () => {
  ...
  return (
    <div
      id="contact1"
      className="pt-5 contact1 flex flex-col justify-center relative w-full h-screen"
    >
      <div className="relative flex flex-col justify-center items-center w-full text-center">
        <h2 className="sm:text-4xl md:text-6xl lg:text-9xl font-sans font-light text-indigo-900">Connect now!</h2>
        <p className="mt-2 sm:text-xl xl:text-2xl font-thin">This is all you need to know</p>
        <div className="relative w-1/2 justify-center items-center" id="vismeFormContainer">
